...
export function RaceInterface() {
  ...
  const isLoadingFuelTime = (!state.fuelTankStartTime && !(state.practiceCompleted && !state.isRaceActive && state.fuelTankStartTime !== null)) && !raceNotYetStartedAndHasFutureStartTime;
